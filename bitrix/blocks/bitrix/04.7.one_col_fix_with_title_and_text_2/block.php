<section class="landing-block landing-semantic-background-color js-animation fadeInUp g-bg-gray-light-v5 g-pt-30 g-pb-30">
	<div class="landing-block-node-container container g-max-width-container">
		<div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom text-left g-brd-primary g-mb-20">
			<h6 class="landing-block-node-subtitle landing-semantic-subtitle-medium-primary g-font-weight-700 g-color-primary g-mb-20">
				Testimonials</h6>
		...
		<div class="landing-block-node-text landing-semantic-text-medium g-pb-1">
